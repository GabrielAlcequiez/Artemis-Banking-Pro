...
namespace ABP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260812201948_EnforceUniqueCommerceUserAssociation")]
    partial class EnforceUniqueCommerceUserAssociation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABP.Domain.Entities.User", b =>
                {
                    b.HasOne("ABP.Domain.Entities.Commerce.Commerce", null)
                        .WithOne()
                        .HasForeignKey("ABP.Domain.Entities.User", "CommerceId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
